...
<iframe src="../diagrams/one-shot-run.html" title="movelooper one-shot run flow" width="100%" height="760" style="border:1px solid #30363d;border-radius:8px" loading="lazy"></iframe>
...
<!-- markdownlint-disable MD033 -->
<iframe src="../diagrams/watch-mode.html" title="movelooper watch mode flow" width="100%" height="760" style="border:1px solid #30363d;border-radius:8px" loading="lazy"></iframe>
<!-- markdownlint-enable MD033 -->
...
<!-- markdownlint-disable MD033 -->
<iframe src="../diagrams/undo.html" title="movelooper undo flow" width="100%" height="760" style="border:1px solid #30363d;border-radius:8px" loading="lazy"></iframe>
<!-- markdownlint-enable MD033 -->
